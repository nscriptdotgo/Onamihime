...
gear.telchine_enh_body = { name="Telchine Chas.", augments={'"Conserve MP"+4','Enh. Mag. eff. dur. +5',}}
...
gear.grioavolr_fc_staff = {name="Grioavolr", augments={'"Fast Cast"+3','MP+92',}}
...
gear.merlinic_treasure_feet = {name="Merlinic Crackows", augments={'Accuracy+6','DEX+7','"Treasure Hunter"+2','Accuracy+18 Attack+18',}}    
